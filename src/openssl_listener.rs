//TODO: import async-std-openssl as crate instead of copying it here
...
pub(crate) struct SslStream<S>(ssl::SslStream<StreamWrapper<S>>);
    ...
    S: AsyncRead + AsyncWrite,
{
    ...
    pub(crate) async fn connect(mut self: Pin<&mut Self>) -> Result<(), ssl::Error> {
    ...
    pub(crate) async fn do_handshake(mut self: Pin<&mut Self>) -> Result<(), ssl::Error> {
